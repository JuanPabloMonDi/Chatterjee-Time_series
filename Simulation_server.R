...
#Fixed terms
n_sim=200 #Number os simulations
...
folder_path <- "Chatterjee_sim/Results"
...
write.csv(pp, file=paste0(folder_path,"/Results_Pearson.csv"),col.names = TRUE,row.names = FALSE)
write.csv(ppart, file=paste0(folder_path,"/Results_Pearson_pacf.csv"),col.names = TRUE,row.names = FALSE)
write.csv(psp, file=paste0(folder_path,"/Results_Spearman.csv"),col.names = TRUE,row.names = FALSE)
write.csv(pk, file=paste0(folder_path,"/Results_Kendall.csv"),col.names = TRUE,row.names = FALSE)
write.csv(pxi, file=paste0(folder_path,"/Results_Chatterjee.csv"),col.names = TRUE,row.names = FALSE)
write.csv(paic, file=paste0(folder_path,"/Results_AIC.csv"),col.names = TRUE,row.names = FALSE)
write.csv(pbic, file=paste0(folder_path,"/Results_BIC.csv"),col.names = TRUE,row.names = FALSE)
write.csv(pcodec, file=paste0(folder_path,"/Results_FOCI.csv"),col.names = TRUE,row.names = FALSE)
